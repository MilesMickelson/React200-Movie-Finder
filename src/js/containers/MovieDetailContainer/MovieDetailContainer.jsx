    ...
    return (
      <div>
        ...
        <div className='goback-wrap'>
          <button type='button' href='#' onClick={this.goBack}
          className='goBack-button'>Go Back!</button>
        </div>
        ...
        <div className='moreInfo-wrapper'>
          ...
          <div className='infoPoster-wrapper'>
            <img src={movie[0].Poster != "N/A" ? movie[0].Poster : null}
          ...
          <div className='moreInfo-box'>
            <div className='col-12'>
              ...
              <div className='row'>
                ...
                metaScore: {movie[0].Metascore != "N/A"
                ? movie[0].Metascore
                : "No Metascore Available"}
                </div>
                <div className='imdb'>
                imdB Rating: {movie[0].imdbRating != "N/A"
                ? movie[0].imdbRating
