      ...
      <div>
        ...
        <div id='movieSearch-wrap'>
          <div className='search-bar'>
            <input type='text' placeholder='Enter movie here' name='search'
            id='movieInput' value={movie} onChange={this.handleMovieInput} />
            <button className='search' type='text' type='submit'
            ...
            {lineItems.map(lineItem => (
                <div className='movie-box'>
                  <div className='poster-wrap'>
                    <img src={lineItem.Poster != "N/A" ? lineItem.Poster : null }
                    ...
                    <div className='info-column'>
                      ...
                      <div className='row'>
                        <div className='plot'>
                          {lineItem.Plot != "N/A"
                          ? lineItem.Plot
                          : "No Plot Information Available"}</div>
                      </div>
                      <div className='moreInfo-row'>
                        <button type='button' className='moreInfo-button' onClick={this.clickHandler} value={lineItem.imdbID}
                        id={"frog" + lineItems.indexOf(lineItem)} className='more-info-button'>More Information</button>
                      </div>
                    </div>
                  </div>
                </div>
